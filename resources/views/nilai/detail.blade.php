        ...
        <div class="card bg-secondary shadow">
            <div class="card-header bg-white border-0">
                <div class="row align-items-center">
                    <div class="col-md-9">
                        <h3 class="mb-0">{{ $mahasiswa->nama }} | Daftar Nilai</h3>
                    </div>
                    <div class="col-md-3">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="input-email" class="form-control form-control-alternative" value="{{ $mahasiswa->user->email }}" readonly>
                    </div>
                    </div>
                    <div class="col-lg-6">
                    <div class="form-group">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary btn-sm" id="btn-update" value="update">Simpan</button>
                    </div>
                </div>
            </div>
        </div>
