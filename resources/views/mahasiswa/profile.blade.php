...
@section('title', 'SIMAK | Profil Mahasiswa')

@section('head', 'Profil Mahasiswa')
...
<div class="container-fluid mt--8">
    <div class="row">
        ...
        <div class="card bg-secondary shadow mb-5">
            ...
            <div class="row align-items-center">
                <div class="col-12">
                <h3>{{ $mahasiswa->nama }} | Mahasiswa <a href="{{ route('mahasiswa.index') }}" class="badge badge-primary float-right">kembali</a></h3>
            ...
            <form>
                ...
                <hr class="my-4">
                <h6 class="heading-small text-muted mb-4">Daftar Mata Kuliah</h6>
                <div class="row mt-4">
                    <div class="col-lg">
                            ...
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td scope="row">
                                        <a class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin akan menghapus data ini?')" href=""><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
    ...
    {{-- <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <form action="{{ route('Mahasiswamatkul.add') }}" method="post">
                @csrf
